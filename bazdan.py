...
# function for execute query without output
...
# function for execute query with output
...
# supporting function for add notification after creating new reminder
...
# supporting function for add notification after dely old reminder
...
# function for store new timezone for user
...
# function for deleting reminder
...
# function for display existing reminders for following deleting them
...
# function for display reminders for certain time frame
